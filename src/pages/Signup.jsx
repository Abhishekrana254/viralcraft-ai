...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (result.success) {
      toast.success('Account created successfully! Welcome to ViralCraft AI!')
      navigate('/dashboard')
    } else {
  ...
  const benefits = [
    'Generate unlimited AI content ideas',
        ...
        >
          <div className="p-8">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Join 50,000+ creators who are already
              <span className="text-gradient block">going viral with AI</span>
            </h2>
